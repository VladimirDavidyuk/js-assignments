...
function encodeToRot13(str) {
    ...
    {
       if (str.charCodeAt(i) >= 'A'.charCodeAt() && str.charCodeAt(i) <= 'M'.charCodeAt())
            encodedStr += String.fromCharCode(str.charCodeAt(i) + 13);
       else if (str.charCodeAt(i) > 'M'.charCodeAt() && str.charCodeAt(i) <= 'Z'.charCodeAt())
            encodedStr += String.fromCharCode(str.charCodeAt(i) - 13);
       else if (str.charCodeAt(i) >= 'a'.charCodeAt() && str.charCodeAt(i) <= 'm'.charCodeAt())
            encodedStr += String.fromCharCode(str.charCodeAt(i) + 13);
       else if (str.charCodeAt(i) > 'm'.charCodeAt() && str.charCodeAt(i) <= 'z'.charCodeAt())
            encodedStr += String.fromCharCode(str.charCodeAt(i) - 13);
        else 
